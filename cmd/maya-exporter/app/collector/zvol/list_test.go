...
func TestZfsListCollector(t *testing.T) {
	...
	cases := map[string]struct {
		...
		"Test0": {
			...
			expectedOutput: []string{
				`openebs_available_size{name="cstor-f1ea249b-417d-11e9-9c76-42010a8001a5"} 3000`,
				`openebs_available_size{name="cstor-f1ea249b-417d-11e9-9c76-42010a8001a5/pvc-c4a68fa3-4183-11e9-9c76-42010a8001a5"} 3000`,
				`openebs_available_size{name="cstor-f1ea249b-417d-11e9-9c76-42010a8001a5/pvc-c4a68fa3-4183-11e9-9c76-42010a8001a5_rebuild_clone"} 3000`,
				`openebs_used_size{name="cstor-f1ea249b-417d-11e9-9c76-42010a8001a5"} 238592`,
				`openebs_used_size{name="cstor-f1ea249b-417d-11e9-9c76-42010a8001a5/pvc-c4a68fa3-4183-11e9-9c76-42010a8001a5"} 6144`,
				`openebs_used_size{name="cstor-f1ea249b-417d-11e9-9c76-42010a8001a5/pvc-c4a68fa3-4183-11e9-9c76-42010a8001a5_rebuild_clone"} 0`,
			},
		},
		"Test1": {
			// expected output if there is one volume with different used size
			...
			expectedOutput: []string{
				...
				`openebs_available_size{name="cstor-f1ea249b-417d-11e9-9c76-42010a8001a5/pvc-c4a68fa3-4183-11e9-9c76-42010a8001a5_rebuild_clone"} 3000`,
				`openebs_used_size{name="cstor-f1ea249b-417d-11e9-9c76-42010a8001a5"} 238592`,
				`openebs_used_size{name="cstor-f1ea249b-417d-11e9-9c76-42010a8001a5/pvc-c4a68fa3-4183-11e9-9c76-42010a8001a5"} 3055`,
				`openebs_used_size{name="cstor-f1ea249b-417d-11e9-9c76-42010a8001a5/pvc-c4a68fa3-4183-11e9-9c76-42010a8001a5_rebuild_clone"} 0`,
			},
		},
		"Test2": {
			...
			expectedOutput: []string{
				`openebs_available_size{name="cstor-f1ea249b-417d-11e9-9c76-42010a8001a5"} 3000`,
				`openebs_available_size{name="cstor-f1ea249b-417d-11e9-9c76-42010a8001a5/pvc-c1a68fa3-4183-11e9-9c76-42010a8001a5"} 3000`,
				`openebs_available_size{name="cstor-f1ea249b-417d-11e9-9c76-42010a8001a5/pvc-c1a68fa3-4183-11e9-9c76-42010a8001a5_rebuild_clone"} 3000`,
				`openebs_available_size{name="cstor-f1ea249b-417d-11e9-9c76-42010a8001a5/pvc-c4a68fa3-4183-11e9-9c76-42010a8001a5"} 3000`,
				`openebs_available_size{name="cstor-f1ea249b-417d-11e9-9c76-42010a8001a5/pvc-c4a68fa3-4183-11e9-9c76-42010a8001a5_rebuild_clone"} 3000`,
				`openebs_used_size{name="cstor-f1ea249b-417d-11e9-9c76-42010a8001a5"} 238592`,
				`openebs_used_size{name="cstor-f1ea249b-417d-11e9-9c76-42010a8001a5/pvc-c1a68fa3-4183-11e9-9c76-42010a8001a5"} 6144`,
				`openebs_used_size{name="cstor-f1ea249b-417d-11e9-9c76-42010a8001a5/pvc-c1a68fa3-4183-11e9-9c76-42010a8001a5_rebuild_clone"} 0`,
				`openebs_used_size{name="cstor-f1ea249b-417d-11e9-9c76-42010a8001a5/pvc-c4a68fa3-4183-11e9-9c76-42010a8001a5"} 6144`,
				`openebs_used_size{name="cstor-f1ea249b-417d-11e9-9c76-42010a8001a5/pvc-c4a68fa3-4183-11e9-9c76-42010a8001a5_rebuild_clone"} 0`,
			},
		},
		"Test3": {
			...
			expectedOutput: []string{
				`openebs_available_size{name="cstor-f1ea249b-417d-11e9-9c76-42010a8001a5"} 3000`,
				`openebs_available_size{name="cstor-f1ea249b-417d-11e9-9c76-42010a8001a5/pvc-c3a68fa3-4183-11e9-9c76-42010a8001a5"} 3000`,
				`openebs_available_size{name="cstor-f1ea249b-417d-11e9-9c76-42010a8001a5/pvc-c3a68fa3-4183-11e9-9c76-42010a8001a5_rebuild_clone"} 3000`,
				`openebs_available_size{name="cstor-f1ea249b-417d-11e9-9c76-42010a8001a5/pvc-c1a68fa3-4183-11e9-9c76-42010a8001a5"} 3000`,
				`openebs_available_size{name="cstor-f1ea249b-417d-11e9-9c76-42010a8001a5/pvc-c1a68fa3-4183-11e9-9c76-42010a8001a5_rebuild_clone"} 3000`,
				`openebs_available_size{name="cstor-f1ea249b-417d-11e9-9c76-42010a8001a5/pvc-c4a68fa3-4183-11e9-9c76-42010a8001a5"} 3000`,
				`openebs_available_size{name="cstor-f1ea249b-417d-11e9-9c76-42010a8001a5/pvc-c4a68fa3-4183-11e9-9c76-42010a8001a5_rebuild_clone"} 3000`,
				`openebs_used_size{name="cstor-f1ea249b-417d-11e9-9c76-42010a8001a5"} 238592`,
				`openebs_used_size{name="cstor-f1ea249b-417d-11e9-9c76-42010a8001a5/pvc-c3a68fa3-4183-11e9-9c76-42010a8001a5"} 6144`,
				`openebs_used_size{name="cstor-f1ea249b-417d-11e9-9c76-42010a8001a5/pvc-c3a68fa3-4183-11e9-9c76-42010a8001a5_rebuild_clone"} 0`,
				`openebs_used_size{name="cstor-f1ea249b-417d-11e9-9c76-42010a8001a5/pvc-c1a68fa3-4183-11e9-9c76-42010a8001a5"} 6144`,
				`openebs_used_size{name="cstor-f1ea249b-417d-11e9-9c76-42010a8001a5/pvc-c1a68fa3-4183-11e9-9c76-42010a8001a5_rebuild_clone"} 0`,
				`openebs_used_size{name="cstor-f1ea249b-417d-11e9-9c76-42010a8001a5/pvc-c4a68fa3-4183-11e9-9c76-42010a8001a5"} 6144`,
				`openebs_used_size{name="cstor-f1ea249b-417d-11e9-9c76-42010a8001a5/pvc-c4a68fa3-4183-11e9-9c76-42010a8001a5_rebuild_clone"} 0`,
