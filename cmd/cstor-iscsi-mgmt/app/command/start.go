...
import (
	...
	"github.com/openebs/maya/cmd/cstor-iscsi-mgmt/controller"
	"github.com/spf13/cobra"
)

// CmdStartOptions has flags for starting CStorIscsi watcher.
type CmdStartOptions struct {
	kubeconfig string
}

// NewCmdStart starts watching for CStorIscsi resource events.
func NewCmdStart() *cobra.Command {
	options := CmdStartOptions{}
	getCmd := &cobra.Command{
		Use:   "start",
		Short: "starts CStorIscsi watcher",
		Long: `CStorIscsi resources will be watched for 
