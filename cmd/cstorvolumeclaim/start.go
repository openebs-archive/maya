...
import (
	...
	leader "github.com/openebs/maya/pkg/kubernetes/leaderelection/v1alpha1"
...
var (
	masterURL              string
	kubeconfig             string
	leaderElectionLockName = "cvc-controller-leader-election"
)
...
func Start() error {
	...
	if !*leaderElection {
		...
		if err := le.Run(); err != nil {
			glog.Fatalf("failed to initialize leader election: %v", err)
		}
	}
	return nil
}
