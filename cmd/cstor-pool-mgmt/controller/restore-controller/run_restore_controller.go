...
func (c *CStorRestoreController) Run(threadiness int, stopCh <-chan struct{}) error {
	...
	if ok := cache.WaitForCacheSync(stopCh, c.CStorRestoreSynced); !ok {
...
// workqueue.
func (c *CStorRestoreController) runWorker() {
...
func (c *CStorRestoreController) processNextWorkItem() bool {
