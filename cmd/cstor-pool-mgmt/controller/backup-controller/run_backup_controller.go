...
func (c *CStorBackupController) Run(threadiness int, stopCh <-chan struct{}) error {
	...
	if ok := cache.WaitForCacheSync(stopCh, c.CStorBackupSynced); !ok {
...
// workqueue.
func (c *CStorBackupController) runWorker() {
...
func (c *CStorBackupController) processNextWorkItem() bool {
