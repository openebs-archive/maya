...
func (in *UpgradeResource) DeepCopyInto(out *UpgradeResource) {
	*out = *in
	if in.BeforeUpgrade != nil {
		in, out := &in.BeforeUpgrade, &out.BeforeUpgrade
		*out = make([]ResourceState, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
	if in.AfterUpgrade != nil {
		in, out := &in.AfterUpgrade, &out.AfterUpgrade
		*out = make([]ResourceState, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
...
func (in *UpgradeResultStatus) DeepCopyInto(out *UpgradeResultStatus) {
	*out = *in
	if in.ResourceList != nil {
		...
		*out = make([]UpgradeResource, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
