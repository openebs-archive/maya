...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *UpgradeResultSpec) DeepCopyInto(out *UpgradeResultSpec) {
	*out = *in
	return
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new UpgradeResultSpec.
func (in *UpgradeResultSpec) DeepCopy() *UpgradeResultSpec {
	if in == nil {
		return nil
	}
	out := new(UpgradeResultSpec)
	in.DeepCopyInto(out)
	return out
}
