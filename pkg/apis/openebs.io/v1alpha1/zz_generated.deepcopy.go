...
func (in *CStorPool) DeepCopyInto(out *CStorPool) {
	*out = *in
	...
	if in.Operations != nil {
		...
		*out = make([]CstorOperation, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *CstorOperation) DeepCopyInto(out *CstorOperation) {
	*out = *in
	if in.NewDisks != nil {
		in, out := &in.NewDisks, &out.NewDisks
		*out = make([]string, len(*in))
		copy(*out, *in)
	}
	if in.OldDisk != nil {
		in, out := &in.OldDisk, &out.OldDisk
		*out = make([]string, len(*in))
		copy(*out, *in)
	}
	return
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new CstorOperation.
func (in *CstorOperation) DeepCopy() *CstorOperation {
	if in == nil {
		return nil
	}
	out := new(CstorOperation)
	in.DeepCopyInto(out)
	return out
}
