...
func (in *CStorVolumePolicySpec) DeepCopyInto(out *CStorVolumePolicySpec) {
	*out = *in
	...
	in.ReplicaPool.DeepCopyInto(&out.ReplicaPool)
	return
}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *ReplicaPoolSpec) DeepCopyInto(out *ReplicaPoolSpec) {
	*out = *in
	if in.PoolInfo != nil {
		in, out := &in.PoolInfo, &out.PoolInfo
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new ReplicaPoolSpec.
func (in *ReplicaPoolSpec) DeepCopy() *ReplicaPoolSpec {
	if in == nil {
		return nil
	}
	out := new(ReplicaPoolSpec)
	in.DeepCopyInto(out)
	return out
}
