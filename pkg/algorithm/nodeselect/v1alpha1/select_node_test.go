...
//			blockdeviceList, _ := ac.NodeDiskSelector()
//			if blockdeviceList == nil {
//				t.Fatalf("Got nil blockdevice list")
//			}
//			if len(blockdeviceList.Disks.Items) != test.expectedDiskListLength {
//				t.Errorf("Test case failed as the expected blockdevice list length is %d but got %d", test.expectedDiskListLength, len(blockdeviceList.Disks.Items))
//			}
//		})
//	}
//}
