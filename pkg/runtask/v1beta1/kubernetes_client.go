...
import (
	...
	"github.com/openebs/maya/pkg/client/generated/openebs.io/runtask/v1beta1/clientset/internalclientset"
...
// getRuntaskFunc is a typed function to get RunTask instance
//
// NOTE:
//  functional makes it simple to mock
type getRuntaskFunc func(k *kubeclient, cs *internalclientset.Clientset, name string) (*apis.RunTask, error)

// getRuntask returns the Runtask instance corresponding to
// the provided name
//
// NOTE:
//  This is an implementation of getRuntaskFunc
func getRuntask(k *kubeclient, cs *internalclientset.Clientset, name string) (*apis.RunTask, error) {
	if k == nil {
	...
	return cs.OpenebsV1beta1().RunTasks(k.namespace).Get(name, v1.GetOptions{})
}
...
type kubeclient struct {
	*kube.Client                              // embeds kubernetes client related functions
	...
	getClientset getClientsetFunc             // handle to get clientset to invoke API calls against RunTask
	getRuntask   getRuntaskFunc               // handle to get RunTask instance
...
func (k *kubeclient) getInternalClientset() (*internalclientset.Clientset, error) {
	...
	if err != nil {
		return nil, errors.Wrap(err, "failed to get runtask clientset")
	}
...
// Get returns a runtask instance from kubernetes cluster
func (k *kubeclient) Get(name string) (*apis.RunTask, error) {
