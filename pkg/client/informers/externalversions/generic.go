...
func (f *sharedInformerFactory) ForResource(resource schema.GroupVersionResource) (GenericInformer, error) {
	switch resource {
	// Group=Openebs, Version=V1alpha1
	...
	case v1alpha1.SchemeGroupVersion.WithResource("cstorreplicas"):
		return &genericInformer{resource: resource.GroupResource(), informer: f.Openebs().V1alpha1().CstorReplicas().Informer()}, nil
