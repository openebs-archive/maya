...
import (
	...
	openebsiov1beta1 "github.com/openebs/maya/pkg/apis/openebs.io/v1beta1"
	...
	v1beta1 "github.com/openebs/maya/pkg/client/generated/listers/openebs.io/v1beta1"
...
type StoragePoolClaimInformer interface {
	...
	Lister() v1beta1.StoragePoolClaimLister
}
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.OpenebsV1beta1().StoragePoolClaims().List(options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.OpenebsV1beta1().StoragePoolClaims().Watch(options)
			},
		},
		&openebsiov1beta1.StoragePoolClaim{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *storagePoolClaimInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&openebsiov1beta1.StoragePoolClaim{}, f.defaultInformer)
}

func (f *storagePoolClaimInformer) Lister() v1beta1.StoragePoolClaimLister {
	return v1beta1.NewStoragePoolClaimLister(f.Informer().GetIndexer())
}
