...
type CStorVolumePolicyInformer interface {
	...
	Lister() v1alpha1.CStorVolumePolicyLister
}
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.OpenebsV1alpha1().CStorVolumePolicies(namespace).List(options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.OpenebsV1alpha1().CStorVolumePolicies(namespace).Watch(options)
			},
		},
		&openebsiov1alpha1.CStorVolumePolicy{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *cStorVolumePolicyInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&openebsiov1alpha1.CStorVolumePolicy{}, f.defaultInformer)
}

func (f *cStorVolumePolicyInformer) Lister() v1alpha1.CStorVolumePolicyLister {
	return v1alpha1.NewCStorVolumePolicyLister(f.Informer().GetIndexer())
}
