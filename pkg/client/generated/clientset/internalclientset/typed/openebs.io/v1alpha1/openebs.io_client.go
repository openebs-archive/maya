...
import (
	...
	"github.com/openebs/maya/pkg/client/generated/clientset/internalclientset/scheme"
...
type OpenebsV1alpha1Interface interface {
	...
	CASTemplatesGetter
	CStorBackupsGetter
	CStorBackupDatasGetter
	CStorPoolsGetter
	CStorRestoresGetter
	CStorRestoreDatasGetter
	CStorVolumesGetter
...
func (c *OpenebsV1alpha1Client) CStorBackupDatas(namespace string) CStorBackupDataInterface {
	return newCStorBackupDatas(c, namespace)
}
...
func (c *OpenebsV1alpha1Client) CStorRestoreDatas(namespace string) CStorRestoreDataInterface {
	return newCStorRestoreDatas(c, namespace)
}
