...
type StoragePoolClaimInterface interface {
	Create(*v1beta1.StoragePoolClaim) (*v1beta1.StoragePoolClaim, error)
	Update(*v1beta1.StoragePoolClaim) (*v1beta1.StoragePoolClaim, error)
	Delete(name string, options *v1.DeleteOptions) error
	DeleteCollection(options *v1.DeleteOptions, listOptions v1.ListOptions) error
	Get(name string, options v1.GetOptions) (*v1beta1.StoragePoolClaim, error)
	List(opts v1.ListOptions) (*v1beta1.StoragePoolClaimList, error)
	Watch(opts v1.ListOptions) (watch.Interface, error)
	Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *v1beta1.StoragePoolClaim, err error)
...
func newStoragePoolClaims(c *OpenebsV1beta1Client) *storagePoolClaims {
...
func (c *storagePoolClaims) Get(name string, options v1.GetOptions) (result *v1beta1.StoragePoolClaim, err error) {
	result = &v1beta1.StoragePoolClaim{}
	err = c.client.Get().
...
func (c *storagePoolClaims) List(opts v1.ListOptions) (result *v1beta1.StoragePoolClaimList, err error) {
	result = &v1beta1.StoragePoolClaimList{}
	err = c.client.Get().
		Resource("storagepoolclaims").
...
func (c *storagePoolClaims) Create(storagePoolClaim *v1beta1.StoragePoolClaim) (result *v1beta1.StoragePoolClaim, err error) {
	result = &v1beta1.StoragePoolClaim{}
	err = c.client.Post().
		Resource("storagepoolclaims").
...
func (c *storagePoolClaims) Update(storagePoolClaim *v1beta1.StoragePoolClaim) (result *v1beta1.StoragePoolClaim, err error) {
	result = &v1beta1.StoragePoolClaim{}
	err = c.client.Put().
		Resource("storagepoolclaims").
...
func (c *storagePoolClaims) Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *v1beta1.StoragePoolClaim, err error) {
	result = &v1beta1.StoragePoolClaim{}
