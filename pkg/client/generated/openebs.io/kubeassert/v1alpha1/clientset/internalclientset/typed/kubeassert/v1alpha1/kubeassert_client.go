...
import (
	...
	"github.com/openebs/maya/pkg/client/generated/openebs.io/kubeassert/v1alpha1/clientset/internalclientset/scheme"
...
func (c *OpenebsV1alpha1Client) KubeAsserts(namespace string) KubeAssertInterface {
	return newKubeAsserts(c, namespace)
}
