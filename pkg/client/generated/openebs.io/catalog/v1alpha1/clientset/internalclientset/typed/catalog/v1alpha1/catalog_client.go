...
import (
	...
	"github.com/openebs/maya/pkg/client/generated/openebs.io/catalog/v1alpha1/clientset/internalclientset/scheme"
...
func (c *OpenebsV1alpha1Client) Catalogs(namespace string) CatalogInterface {
