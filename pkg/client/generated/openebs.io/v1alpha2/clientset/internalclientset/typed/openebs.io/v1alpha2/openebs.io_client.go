...
import (
	...
	"github.com/openebs/maya/pkg/client/generated/openebs.io/v1alpha2/clientset/internalclientset/scheme"
...
func (c *OpenebsV1alpha2Client) CStorNPools(namespace string) CStorNPoolInterface {
	return newCStorNPools(c, namespace)
}
