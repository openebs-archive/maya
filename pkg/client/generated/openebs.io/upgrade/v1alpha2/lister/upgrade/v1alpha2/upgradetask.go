...
type UpgradeTaskLister interface {
	...
	List(selector labels.Selector) (ret []*v1alpha2.UpgradeTask, err error)
...
// List lists all UpgradeTasks in the indexer.
func (s *upgradeTaskLister) List(selector labels.Selector) (ret []*v1alpha2.UpgradeTask, err error) {
	err = cache.ListAll(s.indexer, selector, func(m interface{}) {
		ret = append(ret, m.(*v1alpha2.UpgradeTask))
	})
	return ret, err
}
...
type UpgradeTaskNamespaceLister interface {
	...
	Get(name string) (*v1alpha2.UpgradeTask, error)
...
// List lists all UpgradeTasks in the indexer for a given namespace.
func (s upgradeTaskNamespaceLister) List(selector labels.Selector) (ret []*v1alpha2.UpgradeTask, err error) {
...
// Get retrieves the UpgradeTask from the indexer for a given namespace and name.
func (s upgradeTaskNamespaceLister) Get(name string) (*v1alpha2.UpgradeTask, error) {
	obj, exists, err := s.indexer.GetByKey(s.namespace + "/" + name)
	if err != nil {
		return nil, err
	}
	if !exists {
		return nil, errors.NewNotFound(v1alpha2.Resource("upgradetask"), name)
	}
	return obj.(*v1alpha2.UpgradeTask), nil
}
