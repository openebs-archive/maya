...
import (
	...
	scheme "github.com/openebs/maya/pkg/client/generated/openebs.io/upgrade/v1alpha2/clientset/internalclientset/scheme"
...
type UpgradeTaskInterface interface {
	Create(*v1alpha2.UpgradeTask) (*v1alpha2.UpgradeTask, error)
	Update(*v1alpha2.UpgradeTask) (*v1alpha2.UpgradeTask, error)
	UpdateStatus(*v1alpha2.UpgradeTask) (*v1alpha2.UpgradeTask, error)
	Delete(name string, options *v1.DeleteOptions) error
	DeleteCollection(options *v1.DeleteOptions, listOptions v1.ListOptions) error
	Get(name string, options v1.GetOptions) (*v1alpha2.UpgradeTask, error)
	List(opts v1.ListOptions) (*v1alpha2.UpgradeTaskList, error)
	Watch(opts v1.ListOptions) (watch.Interface, error)
	Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *v1alpha2.UpgradeTask, err error)
...
func (c *upgradeTasks) Get(name string, options v1.GetOptions) (result *v1alpha2.UpgradeTask, err error) {
	result = &v1alpha2.UpgradeTask{}
	err = c.client.Get().
		Namespace(c.ns).
...
func (c *upgradeTasks) List(opts v1.ListOptions) (result *v1alpha2.UpgradeTaskList, err error) {
	result = &v1alpha2.UpgradeTaskList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("upgradetasks").
...
func (c *upgradeTasks) Create(upgradeTask *v1alpha2.UpgradeTask) (result *v1alpha2.UpgradeTask, err error) {
	result = &v1alpha2.UpgradeTask{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("upgradetasks").
...
func (c *upgradeTasks) Update(upgradeTask *v1alpha2.UpgradeTask) (result *v1alpha2.UpgradeTask, err error) {
	result = &v1alpha2.UpgradeTask{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("upgradetasks").
...
func (c *upgradeTasks) UpdateStatus(upgradeTask *v1alpha2.UpgradeTask) (result *v1alpha2.UpgradeTask, err error) {
	result = &v1alpha2.UpgradeTask{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("upgradetasks").
...
func (c *upgradeTasks) Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *v1alpha2.UpgradeTask, err error) {
	result = &v1alpha2.UpgradeTask{}
