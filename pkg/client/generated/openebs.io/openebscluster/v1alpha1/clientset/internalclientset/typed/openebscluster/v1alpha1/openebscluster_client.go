...
import (
	...
	"github.com/openebs/maya/pkg/client/generated/openebs.io/openebscluster/v1alpha1/clientset/internalclientset/scheme"
...
func (c *OpenebsV1alpha1Client) OpenebsClusters(namespace string) OpenebsClusterInterface {
	return newOpenebsClusters(c, namespace)
}
