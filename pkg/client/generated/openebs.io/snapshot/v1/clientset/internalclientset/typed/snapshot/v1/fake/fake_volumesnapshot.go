...
func (c *FakeVolumeSnapshots) List(opts v1.ListOptions) (result *snapshotv1.VolumeSnapshotList, err error) {
	obj, err := c.Fake.
...
func (c *FakeVolumeSnapshots) Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *snapshotv1.VolumeSnapshot, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewPatchSubresourceAction(volumesnapshotsResource, c.ns, name, data, subresources...), &snapshotv1.VolumeSnapshot{})
