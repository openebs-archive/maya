	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.OpenebsV1alpha1().VolumeSnapshotDatas().List(options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.OpenebsV1alpha1().VolumeSnapshotDatas().Watch(options)
			},
		},
		&snapshotv1alpha1.VolumeSnapshotData{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *volumeSnapshotDataInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&snapshotv1alpha1.VolumeSnapshotData{}, f.defaultInformer)
}
