...
import (
	...
	snapshotv1alpha1 "github.com/openebs/maya/pkg/apis/openebs.io/snapshot/v1alpha1"
	...
	v1alpha1 "github.com/openebs/maya/pkg/client/generated/openebs.io/snapshot/v1alpha1/lister/snapshot/v1alpha1"
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.OpenebsV1alpha1().VolumeSnapshots(namespace).List(options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.OpenebsV1alpha1().VolumeSnapshots(namespace).Watch(options)
			},
		},
		&snapshotv1alpha1.VolumeSnapshot{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *volumeSnapshotInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&snapshotv1alpha1.VolumeSnapshot{}, f.defaultInformer)
}
