...
import (
	...
	"github.com/openebs/maya/pkg/client/generated/openebs.io/snapshot/v1alpha1/clientset/internalclientset/scheme"
...
func (c *OpenebsV1alpha1Client) VolumeSnapshots(namespace string) VolumeSnapshotInterface {
	return newVolumeSnapshots(c, namespace)
}

func (c *OpenebsV1alpha1Client) VolumeSnapshotDatas() VolumeSnapshotDataInterface {
