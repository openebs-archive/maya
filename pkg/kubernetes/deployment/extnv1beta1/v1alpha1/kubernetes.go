...
type getFn func(cli *kubernetes.Clientset, name, namespace string) (*api_extn_v1beta1.Deployment, error)
...
func (k *kubeclient) Get(name string) (*api_extn_v1beta1.Deployment, error) {
