...
func TestCStorPoolIsNotUID(t *testing.T) {
	...
	for name, mock := range tests {
		...
		mock := mock
		t.Run(name, func(t *testing.T) {
			mockCSP := &CSP{&apis.NewTestCStorPool{ObjectMeta: metav1.ObjectMeta{UID: mock.cspuid}}}
...
func TestHasAnnotation(t *testing.T) {
	...
	for name, test := range tests {
		...
		test := test
		t.Run(name, func(t *testing.T) {
			fakeCSP := &CSP{&apis.NewTestCStorPool{ObjectMeta: metav1.ObjectMeta{Annotations: test.availableAnnotations}}}
