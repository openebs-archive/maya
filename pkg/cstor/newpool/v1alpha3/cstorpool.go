...
func NewListBuilder() *ListBuilder {
	return &ListBuilder{CspList: &CSPList{ObjectList: &apis.NewTestCStorPoolList{}}}
}
...
func ListBuilderForAPIObject(cspAPIList *apis.NewTestCStorPoolList) *ListBuilder {
	newLb := NewListBuilder()
...
func BuilderForAPIObject(cspAPI *apis.NewTestCStorPool) *Builder {
	return &Builder{
		Csp: &CSP{cspAPI},
	}
}
