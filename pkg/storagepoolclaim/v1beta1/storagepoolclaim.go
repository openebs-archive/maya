...
type SPC struct {
	// actual spc object
	Object *apisv1beta1.StoragePoolClaim
}

// SPCList holds the list of StoragePoolClaim api
type SPCList struct {
	// list of storagepoolclaims
	ObjectList *apisv1beta1.StoragePoolClaimList
}
...
func (s *SPC) GetDiskGroupListForNode(nodeName string) []apisv1beta1.StoragePoolClaimDiskGroups {
	nodes := s.Object.Spec.Nodes
	for _, val := range nodes {
	...
	return []apisv1beta1.StoragePoolClaimDiskGroups{}
}
...
func NewBuilder() *Builder {
	return &Builder{
		SPC: &SPC{&apisv1beta1.StoragePoolClaim{}},
	}
}
...
func BuilderForAPIObject(spc *apisv1beta1.StoragePoolClaim) *Builder {
	return &Builder{
		SPC: &SPC{spc},
	}
}
...
func NewListBuilder() *ListBuilder {
	return &ListBuilder{SPCList: &SPCList{ObjectList: &apisv1beta1.StoragePoolClaimList{}}}
}
...
// NewListBuilderForAPIList builds the list based on the provided *apisv1beta1.CStorPoolList.
func NewListBuilderForAPIList(pools *apisv1beta1.StoragePoolClaimList) *ListBuilder {
	newLB := NewListBuilder()
